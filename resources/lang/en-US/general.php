...
return [
    ...
    'maintenance_type_scheduled_audit'   => 'Scheduled Audit',
    'flag_for_decommission'              => 'Flag for decommission consideration',
    'flag_for_decommission_help'         => 'Check this if the asset may need to be retired instead of repaired.',
    'asset_details'                      => 'Asset Details',
    'asset_info_load_error'              => 'Could not load asset details. Please try selecting the asset again.',
    ...
    'resolution_notes_placeholder'       => 'Describe what was done to resolve the issue...',
    'resolved_at'                        => 'Resolved At',
    'disposal_certificate'               => 'Disposal Certificate',
    'upload_disposal_certificate'        => 'Upload Disposal Certificate',
    'decommission_path'                  => 'Decommission Path',
    'repair_path'                        => 'Repair Path',
    'initiate_decommissioning'           => 'Initiate Decommissioning',
    'initiate_decommissioning_help'      => 'Marks this asset as decommissioned and locks it from further use.',
    'confirm_decommission'               => 'Are you sure you want to decommission this asset? This cannot be undone.',
    'sync_orangehrm_offboarding'         => 'Sync OrangeHRM Offboarding',
    'sync_orangehrm_offboarding_help'    => 'Notifies OrangeHRM that this asset has been returned during employee offboarding.',
    'confirm_sync_orangehrm'             => 'Sync the asset return with OrangeHRM for this employee?',
    'mark_as_resolved'                   => 'Mark as Resolved',
    'return_asset_to_active_service'     => 'Return Asset to Active Service',
    'return_to_service_help'             => 'Marks this maintenance request as resolved and returns the asset to active use.',
    'confirm_return_to_service'          => 'Confirm: return this asset to active service?',
    'maintenance_request_closed'         => 'This maintenance request is closed. No further actions are available.',
    ...
    'award'                               => 'Award',
    'awarded'                             => 'Awarded',
    'award_already_made'                  => 'Award already made.',
    'confirm_award_supplier'              => 'Award this contract to :name? All other quotations will be un-awarded.',
    'top_n_results'                       => 'Top :n results',
    'no_quotations_to_score'              => 'No quotations found for this purchase order.',
    'minimum_quotes_required_title'       => 'Minimum 3 quotations required before awarding.',
    'minimum_quotes_required_body'        => 'Only :count of the required :min quotations have been submitted. Collect at least :min before awarding.',
    ...
    'compliance_notes_placeholder'    => 'Enter any compliance, certification, or regulatory notes...',
    'quote_document'                  => 'Quote Document (PDF)',
    'pdf_only_max'                    => 'PDF only, max :size',
    'submit_quotation'                => 'Submit Quotation',
    'quotes_received_count'           => ':count of :min minimum quotes received.',
    'minimum_quotes_met'              => 'Minimum reached.',
    'quotation_awarded_warning_title' => 'Submission locked.',
    'quotation_awarded_warning_body'  => 'The minimum of 3 quotes has been met and a supplier has already been awarded. No further quotes can be submitted for this PO.',
    'quotation_submit_locked'         => 'Submission locked — award already made.',
    ...
    'minimum_3_quotes_required' => 'Min. 3 quotes required',

    // Procurement Module
    'procurement'              => 'Procurement',
    'maintenance_requests'     => 'Maintenance Requests',
    'create_maintenance_request' => 'Log Maintenance Request',
    'no_maintenance_requests'  => 'No maintenance requests found.',
    'maintenance_type'         => 'Type',
    'decommission_needed'      => 'Decommission Needed',

    // Procurement Pipeline Step Labels
    'pl_lifecycle' => 'Procurement Lifecycle',
    'pl_submit'    => 'Submit Request',
    'pl_approve'   => 'Review & Approve',
    'pl_create_po' => 'Issue PO',
    'pl_quotes'    => 'Collect Quotes',
    'pl_award'     => 'Score & Award',
    'pl_receive'   => 'Receive Assets',
    'pl_assign'    => 'Assign to User',
    ...
    'submit_purchase_request'  => 'Submit Purchase Request',
    'form_has_errors'          => 'Please correct the errors below before submitting.',
    'approved'                 => 'Approved',
    'rejected'                 => 'Rejected',
    'approve'                  => 'Approve',
    'reject'                   => 'Reject',
    ...
    'purchase_request_submitted' => 'Purchase request submitted successfully.',
    ...
    'confirm_create_po'        => 'Create a purchase order for this request?',
    'create_purchase_order'    => 'Create Purchase Order',
    'no_purchase_order_yet'    => 'No purchase order has been created for this request yet.',
    'po_number'                => 'PO Number',
    'draft'                    => 'Draft',
    'sent'                     => 'Sent',
    'received'                 => 'Received',
    ...
    'create_asset_from_po'        => 'Create Asset from PO',
    'create_asset_from_po_help'   => 'Create a new asset in Snipe-IT using the procurement details from this PO.',
    'asset_created_linked'        => 'Asset :tag created and linked to this PO.',
    'prefilled_from_po'           => 'Pre-filled from PO',
    'view_asset'                  => 'View Asset',
    'close_po'                    => 'Close PO',
    'confirm_close_po'            => 'Mark this purchase order as closed? This cannot be undone.',
    'asset_checked_out'           => 'Asset checked out',
    'confirm_receipt'             => 'Confirm Receipt',
    'mark_as_received'            => 'Mark as Received',
    'delivery_notes'              => 'Delivery Notes',
    'delivery_notes_placeholder'  => 'e.g. items arrived in good condition, serial numbers noted…',
    'link_asset_optional'         => 'Link to Asset (optional)',
    'link_asset_help'             => 'Select the Snipe-IT asset record created for this item, or leave blank and create it separately.',
    'already_received'            => 'This PO has already been marked as received.',
    'receipt_confirmed'           => 'Assets received and PO marked as delivered.',
    'awaiting_award'              => 'No supplier has been awarded yet. Complete scoring first.',

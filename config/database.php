...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'orangehrm' => [
            'driver' => 'mysql',
            'host' => env('ORANGEHRM_DB_HOST', env('DB_HOST', 'localhost')),
            'port' => (int) env('ORANGEHRM_DB_PORT', env('DB_PORT', 3306)),
            'database' => env('ORANGEHRM_DB_DATABASE', 'orangehrm'),
            'username' => env('ORANGEHRM_DB_USERNAME', env('DB_USERNAME', 'forge')),
            'password' => env('ORANGEHRM_DB_PASSWORD', env('DB_PASSWORD', '')),
            'charset' => 'utf8mb4',

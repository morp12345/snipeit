...
use App\Services\OrangeHRMProvider;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(UrlGenerator $url)
    {
        ...
        \Laravel\Socialite\Facades\Socialite::extend('orangehrm', function ($app) {
            return \Laravel\Socialite\Facades\Socialite::buildProvider(OrangeHRMProvider::class, $app['config']['services.orangehrm']);
        });
    }
